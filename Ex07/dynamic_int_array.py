...
class DynamicIntArray:
    ...
    def remove(self):
        ...
        if self._n <= 0:
            return -1
        if self._n <= math.floor(1 / 3 * self._c):
            # time to resize
...
def test3():
    """array containing 1M elements, 10M operations,
    first append,then remove after reallocation and so on
...
def test4():
    """array containing 1M elements, 10M operations,
    first remove, then append after reallocation and so on
    reallocation: look for id of object!"""
    t4 = DynamicIntArray()
    for i in range(1000000):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--test1", help="execute test function 1",
                        action="store_true")
    parser.add_argument("--test2", help="execute test function 2",
                        action="store_true")
    parser.add_argument("--test3", help="execute test function 3",
                        action="store_true")
    parser.add_argument("--test4", help="execute test function 4",
                        action="store_true")
